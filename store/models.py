...
from django.contrib.auth.models import User # Вроде как механика добавления новых пользователй
...
class Customer(models.Model):
    ...
    email = models.CharField(max_length=200, null=True) # We can also use .EmailField(), mb this method better match to out pr
